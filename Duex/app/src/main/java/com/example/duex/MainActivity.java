...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // getting RecycleatView from xml file
        final RecyclerView recyclerView = findViewById(R.id.homeworkRecycler);

        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        String currentUserUid = currentUser.getUid();

//        DatabaseReference homeworkReference = FirebaseDatabase.getInstance().getReference().child("homework");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot Homework : snapshot.child("Homework").getChildren()){

                    if(Homework.hasChild("name") && Homework.hasChild("addHomeworkDescription") && Homework.hasChild("dueDate")){
                        ...
                        if (currentUserUid.equals(currentUserUid)) {
                            ...
                            MyItems myItems = new MyItems(getName, getDescription, getdueDate);
